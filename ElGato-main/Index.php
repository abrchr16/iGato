...
<html>
    ...
    <body>
        <header><a href="index.php" class="logo"><svg xmlns="http://www.w3.org/2000/svg" width="45" height="35" fill="currentColor" class="bi bi-gitlab" viewBox="0 0 16 15">
          ...
          <a href="../index.php" class="sesion">iniciar sesion</a>
        </header>
        <div class="Cat">
